...
app.get('/', (req, res) => {
    res.send(`
        <html>
            <head><title>HOT789 - Dự đoán siêu cấp</title>
            <style>
            ...
            <body>
                <h1>🎲 HOT789 - Dự đoán Tài Xỉu siêu cấp (đa cửa sổ + xu hướng)</h1>
                <div class="endpoint">
                    <h3>📊 API endpoints:</h3>
                    <ul>
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`🚀 HOT789 server đang chạy tại: http://localhost:${PORT}`);
});
